    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route('home')}}" class="brand-link">
            <img src="{{asset('admin-theme/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">One solution Cms</span>
        </a>
        ...
        <div class="sidebar">
            ...
            {{--<div class="user-panel mt-3 pb-3 mb-3 d-flex">--}}
               ...
               {{-- <div class="info">
                    <a href="#" class="d-block">Suzo Milk</a>
                </div>--}}
           {{-- </div>--}}
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{route('category.service.list')}}" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="{{route('servicecustomer')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                    ...
                    <!-- <li class="nav-item">
                        <a href="{{route('complaint.list')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Complaint
