...
<div class="row">
  <div class="col-md-6">
    <form role="form" method="get"  action="{{route('servicecustomer')}}">
        @csrf
        <div class="row">
          <div class="col-md-12">
                <div class="form-group">
                    <label>Vendore List</label>
        ...
        <div class="row">
          <div class="col-md-12">
                ...
                <div class="form-group"> 
                    ...
                    <a href="{{Route('servicecsutomer')}}" class="btn btn-warning float-right">Download List</a>                
                </div>
